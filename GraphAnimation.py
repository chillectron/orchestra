...
accessibleList = []
elements = ['res','nmos','wire','pmos','idc','vdc','vcvs','vccs','plot','plottrace','text','dot']
...
def draw(obj, position):
	...
	if position==11:
		obj.drawing[0] = c.create_text(obj.drawing_coords[0], text=obj.text, fill=obj.color, font=("Arial", obj.fontsize), angle=obj.angle)

	if position==12:
		obj.drawing[0] = c.create_oval(obj.drawing_coords[0], outline=obj.color,fill=obj.color, width=obj.width)
...
def drawings(obj, position, draw):
	...
	if position==12:
		if draw:
			obj.drawing_coords[0] = (obj.posx-obj.width, obj.posy-obj.width, obj.posx+obj.width, obj.posy+obj.width)
		return 1
...
def scrolate_kernal(obj):
	...
	for i in range(0,obj.items-obj.offset):
		if obj.appear:
...
class PLOT:
	...
	def terminals(self):
		return [[self.drawing_coords[0][0], self.drawing_coords[0][1]]]
...
class PLOT_TRACE:
	def init(self, points, nTimes=20, width=2, color='#FFFFFF'):
		self.xvals, self.yvals = bezier_curve(points, nTimes)
		accessibleList.append(self.xvals)
		accessibleList.append(self.yvals)
		self.width = width
		self.color = color
...
class Orchestra:
	...
	def animate_kernal(self):
		if self.seq == 0:
			plt.init(cwidth/2, cheight/2, 600,600,10,10,1,'#47ADE3')
		if self.seq == 1:
			vdstext.init(plt.terminals()[0][0]+630, plt.terminals()[0][1],'Vds',25)
			idstext.init(plt.terminals()[0][0], plt.terminals()[0][1]-630,'Ids',25)
			pltr.init([[plt.terminals()[0][0],plt.terminals()[0][1]], [plt.terminals()[0][0]+100,plt.terminals()[0][1]-200], [plt.terminals()[0][0]+200,plt.terminals()[0][1]-400], [plt.terminals()[0][0]+300,plt.terminals()[0][1]-420], [plt.terminals()[0][0]+400,plt.terminals()[0][1]-440], [plt.terminals()[0][0]+500,plt.terminals()[0][1]-460]],20,2,'#82FC73')
		if self.seq == 2:
			lx.init(accessibleList[0][1],800,accessibleList[0][1],100,1,'#3B3B3B')
			ly.init(200,accessibleList[1][1],1100,accessibleList[1][1],1,'#3B3B3B')
			lxu.init(accessibleList[0][0],800,accessibleList[0][0],100,1,'#FF6400')
			lyu.init(200,accessibleList[1][0],1100,accessibleList[1][0],1,'#FF6400')
			lxd.init(accessibleList[0][2],800,accessibleList[0][2],100,1,'#FF6400')
			lyd.init(200,accessibleList[1][2],1100,accessibleList[1][2],1,'#FF6400')
			pt.init(accessibleList[0][1], accessibleList[1][1], 3, '#FFFFFF')
		if self.seq == 3:
			pt.scrolate(accessibleList[0][5], accessibleList[1][5], 0,0,0,0,0,0,0,500)
			lx.scrolate(getCenter(lx)[0]+accessibleList[0][5]-accessibleList[0][1], getCenter(lx)[1],0,0,0,0,0,0,0,500)
			ly.scrolate(getCenter(ly)[0],getCenter(ly)[1]+accessibleList[1][5]-accessibleList[1][1],0,0,0,0,0,0,0,500)
			lxu.scrolate(getCenter(lxu)[0]+accessibleList[0][4]-accessibleList[0][0], getCenter(lxu)[1],0,0,0,0,0,0,0,500)
			lyu.scrolate(getCenter(lyu)[0],getCenter(lyu)[1]+accessibleList[1][4]-accessibleList[1][0],0,0,0,0,0,0,0,500)
			lxd.scrolate(getCenter(lxd)[0]+accessibleList[0][6]-accessibleList[0][2], getCenter(lxd)[1],0,0,0,0,0,0,0,500)
			lyd.scrolate(getCenter(lyd)[0],getCenter(lyd)[1]+accessibleList[1][6]-accessibleList[1][2],0,0,0,0,0,0,0,500)
		if self.seq == 4:
			pt.scrolate(accessibleList[0][10], accessibleList[1][10], 0,0,0,0,0,0,0,500)
			lx.scrolate(getCenter(lx)[0]+accessibleList[0][10]-accessibleList[0][5], getCenter(lx)[1],0,0,0,0,0,0,0,500)
			ly.scrolate(getCenter(ly)[0],getCenter(ly)[1]+accessibleList[1][10]-accessibleList[1][5],0,0,0,0,0,0,0,500)
			lxu.scrolate(getCenter(lxu)[0]+accessibleList[0][9]-accessibleList[0][4], getCenter(lxu)[1],0,0,0,0,0,0,0,500)
			lyu.scrolate(getCenter(lyu)[0],getCenter(lyu)[1]+accessibleList[1][9]-accessibleList[1][4],0,0,0,0,0,0,0,500)
			lxd.scrolate(getCenter(lxd)[0]+accessibleList[0][11]-accessibleList[0][6], getCenter(lxd)[1],0,0,0,0,0,0,0,500)
			lyd.scrolate(getCenter(lyd)[0],getCenter(lyd)[1]+accessibleList[1][11]-accessibleList[1][6],0,0,0,0,0,0,0,500)	
		if self.seq == 5:
			pt.scrolate(accessibleList[0][15], accessibleList[1][15], 0,0,0,0,0,0,0,500)
			lx.scrolate(getCenter(lx)[0]+accessibleList[0][15]-accessibleList[0][10], getCenter(lx)[1],0,0,0,0,0,0,0,500)
			ly.scrolate(getCenter(ly)[0],getCenter(ly)[1]+accessibleList[1][15]-accessibleList[1][10],0,0,0,0,0,0,0,500)
			lxu.scrolate(getCenter(lxu)[0]+accessibleList[0][14]-accessibleList[0][9], getCenter(lxu)[1],0,0,0,0,0,0,0,500)
			lyu.scrolate(getCenter(lyu)[0],getCenter(lyu)[1]+accessibleList[1][14]-accessibleList[1][9],0,0,0,0,0,0,0,500)
			lxd.scrolate(getCenter(lxd)[0]+accessibleList[0][16]-accessibleList[0][11], getCenter(lxd)[1],0,0,0,0,0,0,0,500)
			lyd.scrolate(getCenter(lyd)[0],getCenter(lyd)[1]+accessibleList[1][16]-accessibleList[1][11],0,0,0,0,0,0,0,500)						
		if self.seq == 6:
			pt.scrolate(accessibleList[0][8], accessibleList[1][8], 0,0,0,0,0,0,0,500)
			lx.scrolate(getCenter(lx)[0]+accessibleList[0][8]-accessibleList[0][15], getCenter(lx)[1],0,0,0,0,0,0,0,500)
			ly.scrolate(getCenter(ly)[0],getCenter(ly)[1]+accessibleList[1][8]-accessibleList[1][15],0,0,0,0,0,0,0,500)
			lxu.scrolate(getCenter(lxu)[0]+accessibleList[0][7]-accessibleList[0][14], getCenter(lxu)[1],0,0,0,0,0,0,0,500)
			lyu.scrolate(getCenter(lyu)[0],getCenter(lyu)[1]+accessibleList[1][7]-accessibleList[1][14],0,0,0,0,0,0,0,500)			
			lxd.scrolate(getCenter(lxd)[0]+accessibleList[0][9]-accessibleList[0][16], getCenter(lxd)[1],0,0,0,0,0,0,0,500)
			lyd.scrolate(getCenter(lyd)[0],getCenter(lyd)[1]+accessibleList[1][9]-accessibleList[1][16],0,0,0,0,0,0,0,500)			
		if self.seq == 7:
			pt.scrolate(accessibleList[0][3], accessibleList[1][3], 0,0,0,0,0,0,0,500)
			lx.scrolate(getCenter(lx)[0]+accessibleList[0][3]-accessibleList[0][8], getCenter(lx)[1],0,0,0,0,0,0,0,500)
			ly.scrolate(getCenter(ly)[0],getCenter(ly)[1]+accessibleList[1][3]-accessibleList[1][8],0,0,0,0,0,0,0,500)
			lxu.scrolate(getCenter(lxu)[0]+accessibleList[0][2]-accessibleList[0][7], getCenter(lxu)[1],0,0,0,0,0,0,0,500)
			lyu.scrolate(getCenter(lyu)[0],getCenter(lyu)[1]+accessibleList[1][2]-accessibleList[1][7],0,0,0,0,0,0,0,500)
			lxd.scrolate(getCenter(lxd)[0]+accessibleList[0][4]-accessibleList[0][9], getCenter(lxd)[1],0,0,0,0,0,0,0,500)
			lyd.scrolate(getCenter(lyd)[0],getCenter(lyd)[1]+accessibleList[1][4]-accessibleList[1][9],0,0,0,0,0,0,0,500)
